...
def sort_by_sequence(unsorted_list: list):
    """This is a function will order a list of items by sequence"""
    new_list = sorted(unsorted_list, key=lambda item: item.sequence, reverse=True)
    return new_list


def sort_by_size(unsorted_list: list):
    """This is a function will order a list of items by size"""
    new_list = sorted(unsorted_list, key=lambda item: item.size, reverse=True)
    return new_list


def sort_by_priority(unsorted_list: list):
    """This is a function will order a list of items by priority"""
    new_list = sorted(unsorted_list, key=lambda item: item.priority, reverse=True)
    return new_list
